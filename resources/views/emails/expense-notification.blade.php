...
<body>
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #ddd; border-radius: 5px;">
        ...
        <p><strong>Notification Type:</strong> 
            @if($type == 'success')
                <span style="display: inline-block; padding: 3px 12px; background: #27ae60; color: white; border-radius: 4px; font-weight: bold;">APPROVED</span>
            @elseif($type == 'error')
                <span style="display: inline-block; padding: 3px 12px; background: #e74c3c; color: white; border-radius: 4px; font-weight: bold;">REJECTED</span>
            @elseif($type == 'warning')
                <span style="display: inline-block; padding: 3px 12px; background: #f39c12; color: white; border-radius: 4px; font-weight: bold;">ACTION REQUIRED</span>
            @else
                <span style="display: inline-block; padding: 3px 12px; background: #3498db; color: white; border-radius: 4px; font-weight: bold;">INFORMATION</span>
            @endif
        </p>
        
        <div style="background: #f8f9fa; padding: 15px 20px; border-left: 4px solid #3498db; margin: 15px 0; border-radius: 3px;">
        ...
        @if($expenseId)
        <div style="background: #fafafa; padding: 15px 20px; margin: 15px 0; border: 1px solid #eee; border-radius: 4px;">
            ...
            <table style="width: 100%; border-collapse: collapse;">
                ...
                @if($expense)
                    ...
                    <tr>
                        ...
                        <td style="padding: 6px 0; color: #333;">Rs. {{ number_format($expense->amount ?? 0, 2) }}</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td style="padding: 6px 0; color: #333;">{{ date('d M Y', strtotime($expense->expense_date)) }}</td>
                    </tr>
                    @endif
        ...
        <div style="background: #f0f8ff; padding: 15px 20px; margin: 15px 0; border: 1px solid #b8d4e3; border-radius: 4px;">
        ...
        <div style="background: #f8f9fa; padding: 12px 20px; margin: 15px 0; border: 1px solid #eee; border-radius: 4px;">
        ...
        <div style="margin-top: 20px; padding-top: 15px; border-top: 1px solid #ddd; font-size: 12px; color: #888; text-align: center;">
            ...
            <p style="margin: 4px 0; color: #aaa;">&copy; {{ date('Y') }} {{ $appName }}. All rights reserved.</p>
        </div>
    </div>
</body>
</html>